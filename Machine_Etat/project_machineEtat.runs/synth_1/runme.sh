...
HD_PWD='C:/Users/mylen/Desktop/projet_machineEtat/project_machineEtat/project_machineEtat.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_Mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FSM_Mult.tcl
