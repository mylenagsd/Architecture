...
HD_PWD='C:/Users/mylen/Desktop/projet_machineEtat/project_machineEtat/project_machineEtat.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FSM_Mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FSM_Mult.tcl -notrace
