...
## LEDs
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { done_init }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
#set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { en_init }]; #IO_L4N_T0_D05_14 Sch=btnu
...
#set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { wire_rx }]; #IO_L15P_T2_DQS_15 Sch=jb[4]
